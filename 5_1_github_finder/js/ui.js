class UI {
    constructor(){
        //Put profile in the constructor as this is constant we will use
        this.profile = document.getElementById('profile');
    }

    showProfile(user){
        //Create a UI element for the user found
                ...
                <div class="card card-body mb-2">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <span class="badge badge-secondary">Watchers: ${repos.watchers_count}
                            </span>
                            <span class="badge badge-success">Forks: ${repos.forks_count}
                            </span>
                        </div>
                    </div>
                </div>
    ...
    //Clear the profile information in the UI
    clearProfile(){
        this.profile.innerHTML = '';
    }
